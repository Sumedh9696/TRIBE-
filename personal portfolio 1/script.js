/* ================================================================
   SUMEDH PATTHE — 3D Minecraft Portfolio World
...
function animate() {
  ...
  /* ── Animate floating sign ── */
  scene.children.forEach(child => {
    if (child.userData && child.userData.floats) {
      child.position.y = child.userData.baseY + Math.sin(t * 1.5) * 0.3;
    }
  });
...
function checkProximity() {
  ...
  buildingMeshes.forEach(bm => {
    const d = camera.position.distanceTo(bm.worldPos);
